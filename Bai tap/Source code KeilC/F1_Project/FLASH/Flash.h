...
#define PAGE_ADDRESS_0			((uint32_t)0x08000000)
#define PAGE_ADDRESS(page)  (PAGE_ADDRESS_0 + (PAGE_SIZE * page))
#define PAGE_ADDRESS_61 PAGE_ADDRESS(61)
#define PAGE_ADDRESS_62 PAGE_ADDRESS(62)
#define PAGE_ADDRESS_63 PAGE_ADDRESS(63)
